...
def send_gripper_speed_command(base, speed, duration=0.5):
        ...
        while True:
            ...
            if trigger == "q":
                ...
                for i in range(0, num_photos):
                    take_and_save()
                    action = [speed*(random.random()-.5)/5 for i in range(0, 4)]
                    cartesian_action_movement(base, base_cyclic, action[0:3])
                    send_gripper_speed_command(base, action[3])
                continue
            elif trigger == "c":
                ...
                try:
                    ...
                    print("OOPS!")
                    continue   # avoiding action movement 
            cartesian_action_movement(base, base_cyclic, action[0:3])
            #move_gripper(base, action[3])
            send_gripper_speed_command(base, action[3])
